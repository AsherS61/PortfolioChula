        ...
        return (
            <div ref={ref} className="mt-20 flex flex-col md:flex-row bg-gray-800 shadow-lg rounded-lg overflow-hidden  justify-items-center">
                ...
                <div className="w-full md:w-1/2 flex justify-center items-center">
                    <Image src={image} alt={`${name} Image`} width={500} height={300} className="object-contain border-white border-2 rounded-lg border-r-0" />
                </div>
                ...
                <div className="w-full md:w-1/2 p-6 flex flex-col justify-center text-white">
                    ...
                    <div className="mt-2 ">
                        {tags.map((tag) => (
                            <span key={tag} className="bg-blue-600 text-white text-xs font-semibold px-2 py-1 rounded-full mr-2">
                                {tag}
                            </span>
                        ))}
                    </div>
